...
export default function SingleCallModal({ isOpen, onClose, onCallStarted }) {
    ...
    const handleStartCall = async () => {
        ...
        if (callType === 'New Buyer Lead' && !leadSource) {
            toast.warning('Source is required for New Buyer Lead calls.');
            return;
        }
        ...
        try {
            const contacts = [{ 
                ...
                leadSource: callType === 'New Buyer Lead' ? leadSource : undefined
            }];
                    ...
                    {callType === 'New Buyer Lead' && (
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                placeholder="e.g., Zillow, Realtor.com, Referral" 
                            />
                        </div>
                    )}
