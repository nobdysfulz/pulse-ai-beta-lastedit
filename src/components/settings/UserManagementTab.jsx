    ...
    const handleUpdateUser = async (userId, payload) => {
        try {
            ...
            if (data.success) {
                ...
                // If updating the current user, reload to reflect permissions immediately
                // Using a basic check since we don't have UserContext here, 
                // but in admin panel, usually you're updating others. 
                // If admins want "instant" access for themselves, a reload is safest.
