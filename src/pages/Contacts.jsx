          ...
          <div className="p-2">
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg text-sm ${
                activeTab === 'all' ? 'bg-muted text-primary font-medium' : 'text-muted-foreground hover:bg-muted'
              }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg text-sm ${
                activeTab === 'hot' ? 'bg-muted text-primary font-medium' : 'text-muted-foreground hover:bg-muted'
              }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg text-sm ${
                activeTab === 'warm' ? 'bg-muted text-primary font-medium' : 'text-muted-foreground hover:bg-muted'
              }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg text-sm ${
                activeTab === 'new' ? 'bg-muted text-primary font-medium' : 'text-muted-foreground hover:bg-muted'
              }`}
            >
